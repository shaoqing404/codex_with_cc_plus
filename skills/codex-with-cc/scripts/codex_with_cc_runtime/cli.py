...
def build_parser() -> argparse.ArgumentParser:
    ...
    ccstatus_audit = ccstatus_sub.add_parser("audit", allow_abbrev=False)
    audit_target = ccstatus_audit.add_mutually_exclusive_group(required=True)
    audit_target.add_argument("-RunId", dest="run_id")
